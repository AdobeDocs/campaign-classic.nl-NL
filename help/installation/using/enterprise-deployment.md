...
1. Het installatieprogramma van de clientconsole kopiëren **setup-client-7.XX**, **YYYY.exe** aan de **/datakit/nl/eng/jsp** map. [Meer informatie](../../installation/using/client-console-availability-for-windows.md).
