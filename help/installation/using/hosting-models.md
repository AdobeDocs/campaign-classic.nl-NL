...
>[!NOTE]
>
>De belangrijkste installatie en configuratiestappen kunnen slechts door Adobe voor plaatsingen worden uitgevoerd die door Adobe worden ontvangen. Bijvoorbeeld, om de server en de dossiers van de instantieconfiguratie te vormen. Meer over de belangrijkste verschillen tussen plaatsingswijzen leren, verwijs naar [dit artikel](https://helpx.adobe.com/nl/campaign/kb/acc-on-prem-vs-hosted.html). Als u een gehost of hybride model hebt, raadpleegt u deze [sectie](../../installation/using/about-hybrid-and-hosted-models.md).
