...
>[!NOTE]
>
>Raadpleeg ook de [installatiegids](../../installation/using/general-architecture.md) en de [build-upgrade](http://docs.campaign.adobe.com/doc/AC/getting_started/EN/buildUpgrade.html) die aan de slag gaat.
