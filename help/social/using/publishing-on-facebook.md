...
1. Selecteer in het veld **[!UICONTROL Folder]** de servicemap die de Facebook-pagina bevat. Pagina&#39;s worden standaard opgeslagen in de hoofdmap van de servicemap **[!UICONTROL Facebook]**. Selecteer vervolgens de Facebook-pagina waarop u wilt plaatsen.
...
1. Voer in het veld **[!UICONTROL Status]** de tekst in die onder de naam van de pagina wordt weergegeven.
1. Voer in het veld **[!UICONTROL Name]** de titel van de publicatie in.
1. Voer in het veld **[!UICONTROL Link]** de URL in waarnaar de publicatie verwijst.

   >[!NOTE]
   >
   >Als u het veld **[!UICONTROL Link]** wilt toevoegen aan de URL van een Facebook-toepassing om dit te promoten, raden we u aan het veld aan te passen aan de weergavecriteria voor smartphones:
   >
...
1. Voer in het veld **[!UICONTROL Image]** de URL in van de afbeelding die links van de publicatie wordt weergegeven.
...
1. Voer in het veld **[!UICONTROL Status]** de tekst in die onder de naam van de pagina wordt weergegeven.
1. Voer in het veld **[!UICONTROL Name]** de titel van de publicatie in.
1. Voer in het veld **[!UICONTROL Video code]** de code van de YouTube-video in. Voor de koppeling &#39;https://www.youtube.com/watch?v=abc123456&#39;&#39; is de videocode &#39;abc123456&#39;.
1. Voer in het veld **[!UICONTROL Caption]** de tekst in die aan het einde van de publicatie wordt weergegeven.
1. Ga naar het **[!UICONTROL Description]** gebied en ga de tekst in die onder de titel moet worden getoond.
...
1. Begin door **[!UICONTROL Album name]** in te gaan.
1. Voer vervolgens de **[!UICONTROL Description]** in die boven de foto&#39;s moet worden weergegeven.
...
Met het tabblad **[!UICONTROL Preview]** kunt u de rendering van de publicatie weergeven.
...
1. Selecteer in het veld **[!UICONTROL Folder]** de servicemap die uw Facebook-pagina&#39;s bevat. Pagina&#39;s worden standaard in de hoofdmap van de servicemap **[!UICONTROL Facebook]** opgeslagen.
