...
De centrale entiteit creeert samenwerkingscampagnes van **Distributed Marketing** campagnemalplaatjes. Zie [deze pagina](about-distributed-marketing.md#collaborative-campaign).
...
Selecteer de **Op vorm** Webinterface. Met dit type interface kunt u verpersoonlijkingsvelden maken die door lokale entiteiten worden gebruikt wanneer ze een campagne bestellen. Zie [Een lokale campagne maken (op formulier)](examples.md#creating-a-local-campaign--by-form-).
...
Raadpleeg voor meer informatie de sectie [Goedkeuringsproces](creating-a-local-campaign.md#approval-process).
