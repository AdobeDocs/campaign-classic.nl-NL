...
* Voer de **label** van de sjabloon: dit label wordt standaard toegewezen aan alle campagnes die met deze sjabloon worden gemaakt.
...
* Selecteer de **type campagne**: uniek, terugkerend of periodiek. Standaard worden campagnemasjablonen toegepast op unieke campagnes. Recursieve en periodieke campagnes worden beschreven in [deze sectie](../../campaign/using/setting-up-marketing-campaigns.md#recurring-and-periodic-campaigns).
...
Ga in het vak Taakconfiguratie naar de knop **[!UICONTROL Implementation schedule]** gebied en de **[!UICONTROL The start date is calculated based on the campaign end date]** doos. (Hier is &quot;begindatum&quot; de begindatum van de taak.) Ga naar de **[!UICONTROL Start]** veld en voer een interval in: de taak begint zo lang voor de einddatum van de campagne. Als u een periode ingaat die langer is dan de campagne aan laatste wordt geplaatst, zal de taak vóór de campagne beginnen.
