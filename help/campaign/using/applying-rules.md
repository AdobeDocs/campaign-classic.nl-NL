...
## Toepassingsvoorwaarden {#defining-application-conditions} definiëren
...
>[!NOTE]
>
>Voor filterregels kunt u de toepassingsvoorwaarde van filtercriteria selecteren: zij kunnen afhangen van de levering of het leveringsoverzicht . Voor meer op dit, verwijs naar [Conditioning een het filtreren regel](../../campaign/using/filtering-rules.md#conditioning-a-filtering-rule).

## Rekenfrequentie {#adjusting-calculation-frequency} aanpassen
...
### Uitvoeringsvolgorde {#execution-order}
...
### Uitgaand verkeer SMTP van de controle {#control-outgoing-smtp-traffic}
...
### De Optimalisering van de campagne en de Verdeelde Marketing {#campaign-optimization-and-distributed-marketing}
