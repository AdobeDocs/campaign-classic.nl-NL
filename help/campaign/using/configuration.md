...
## Schema&#39;s {#configuring-schemas} configureren
...
In dit voorbeeld integreren we een aankooptabel in onze responsbeheermodule met behulp van de Adobe Campaign-tabel voor ontvangers ( **[!UICONTROL nms:recipient]** ).
...
### Responsbeheer met een gepersonaliseerde tabel voor ontvangers {#response-management-with-a-personalized-recipient-table}
...
* Creërend een nieuw schema van het reactielogboek dat uit het **[!UICONTROL nms:remaMatch]** schema wordt afgeleid.
...
* Het wijzigen van de hypothesevorm in het schema **[!UICONTROL nms:remaHypothesis]**.
...
## Indicatoren {#managing-indicators} beheren
