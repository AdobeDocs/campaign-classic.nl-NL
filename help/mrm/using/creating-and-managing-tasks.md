...
Alle taken worden gegroepeerd in een lijst die via **Campagnes** tabel toegankelijk is. Voor meer op dit, verwijs naar [Taken van de Toegang](#accessing-tasks).
...
Het is mogelijk om documenten en marketingbronnen aan een taak toe te voegen (voor meer informatie hierover gaat u naar [Marketing resources beheren](../../mrm/using/managing-marketing-resources.md)). Open hiertoe de taak en klik op het pictogram **[!UICONTROL Documents]** op de taakwerkbalk.
...
>[!NOTE]
>
>Zie [Kostenvastlegging, berekening en aanrekening](../../mrm/using/controlling-costs.md#cost-commitment--calculation-and-charging) voor meer informatie over uitgaven en budgetten.
...
>[!NOTE]
>
>De methode voor het beheer van budgetten en kosten wordt weergegeven in [Controlekosten](../../mrm/using/controlling-costs.md).
