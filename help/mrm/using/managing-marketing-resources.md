...
[In ](../../mrm/using/discussion-forums.md) discussieforums wordt uitgelegd hoe discussieforums in Adobe Campaign werken.
...
* Als de bron wordt beheerd via een marketingtaak voor het maken van resources, wordt deze uitgevoerd wanneer de taak is ingesteld op **[!UICONTROL Finished]**, zolang het vak **[!UICONTROL Publish the marketing resource]** in de taak is ingeschakeld (Zie [Taak voor het maken van marketingbronnen](../../mrm/using/creating-and-managing-tasks.md#marketing-resource-creation-task))
