...
+ Aan de slag {#getting-started}
   ...
   + [Woordenlijst - VERBORGEN](platform/using/ac-glossary.md)
   + Privacy {#privacy}
...
+ Berichten maken en verzenden {#sending-messages}
   ...
   + Snel starten {#key-steps-when-creating-a-delivery}
      + [Aan de slag met leveringen - VERBORGEN](delivery/using/steps-about-delivery-creation-steps.md)
      + [Een levering maken en identificeren - VERBORGEN](delivery/using/steps-create-and-identify-the-delivery.md)
      + [De doelgroep definiëren - VERBORGEN](delivery/using/steps-defining-the-target-population.md)
      ...
      + [Best practices voor levering - VERBORGEN](delivery/using/delivery-best-practices.md)
   ...
   + E-mails verzenden {#sending-emails}
      ...
      + [De e-mailinhoud definiëren - VERBORGEN](delivery/using/defining-the-email-content.md)
      + [Interactieve content definiëren - VERBORGEN](delivery/using/defining-interactive-content.md)
      + De e-maillevering verzenden {#sending-an-email}
         + [De belangrijkste stappen om een e-mail te verzenden - VERBORGEN](delivery/using/sending-messages.md)
         + [E-mailparameters - VERBORGEN](delivery/using/email-parameters.md)
         + [Verzenden op Japanse mobiele telefoons - VERBORGEN](delivery/using/sending-emails-on-japanese-mobiles.md)
   ...
   + Sms verzenden {#sending-messages-on-mobiles}
      ...
      + [Een sms-levering maken - VERBORGEN](delivery/using/sms-create.md)
   ...
   + Pushmeldingen verzenden {#sending-push-notifications}
      ...
      + De mobiele applicatie configureren{#configure-the-mobile-app}
         + [Aan de slag met de appconfiguratie - VERBORGEN](delivery/using/get-started-app-config.md)
         + [Configuratiestappen voor iOS - VERBORGEN](delivery/using/configuring-the-mobile-application.md)
         + [Configuratiestappen voor Android - VERBORGEN](delivery/using/configuring-the-mobile-application-android.md)
      + Een pushmelding maken{#create-a-push-msg}
         + [Een pushbericht maken voor iOS - VERBORGEN](delivery/using/create-notifications-ios.md)
         + [Een pushbericht maken voor Android - VERBORGEN](delivery/using/create-notifications-android.md)
   ...
   + Direct mail verzenden {#sending-direct-mail}
      + [Een levering voor direct mail maken - VERBORGEN](delivery/using/creating-a-direct-mail-delivery.md)
      + [De inhoud van direct mail definiëren - VERBORGEN](delivery/using/defining-the-direct-mail-content.md)
   ...
   + Leveringssjablonen gebruiken {#using-delivery-templates}
      ...
      + [Een targettoewijzing selecteren - VERBORGEN](delivery/using/selecting-a-target-mapping.md)
      + [Een levering maken met een sjabloon - VERBORGEN](delivery/using/creating-a-delivery-from-a-template.md)
   + Verzendingen personaliseren {#personalizing-deliveries}
      + [Personalisatie](delivery/using/about-personalization.md)
      + [Personalisatievelden - VERBORGEN](delivery/using/personalization-fields.md)
      + [Personalisatieblokken - VERBORGEN](delivery/using/personalization-blocks.md)
      + [Voorwaardelijke inhoud - VERBORGEN](delivery/using/conditional-content.md)
      + [Persoonlijke coupons - VERBORGEN](delivery/using/personalized-coupons.md)
      + [Gepersonaliseerde PDF-documenten genereren - VERBORGEN](delivery/using/generating-personalized-pdf-documents.md)
   ...
   + Verzendingen controleren {#monitoring-deliveries}
      + [Leveringsprestaties monitoren](delivery/using/about-delivery-monitoring.md)
      ...
      + [Leveringsfouten en quarantainebeheer](delivery/using/delivery-failures-quarantine.md)
...
+ Marketingcampagnes orkestreren {#orchestrating-campaigns}
   + [Campagneoptimalisatie - VERBORGEN](campaign-opt/using/about-campaign-optimization.md)
   + Marketingcampagnes {#about-marketing-campaigns}
      + [Marketingcampagnes ontwerpen - VERBORGEN](campaign/using/designing-marketing-campaigns.md)
      + [Toegang tot marketingcampagnes - VERBORGEN](campaign/using/accessing-marketing-campaigns.md)
   + Campagnes orkestreren {#orchestrate-campaigns}
      + [Aan de slag met marketingcampagnes - VERBORGEN](campaign/using/setting-up-marketing-campaigns.md)
      ...
      + [De doelgroep selecteren - VERBORGEN](campaign/using/marketing-campaign-target.md)
      + [Documenten en assets beheren - VERBORGEN](campaign/using/marketing-campaign-assets.md)
      + [Goedkeuringen instellen en beheren - VERBORGEN](campaign/using/marketing-campaign-approval.md)
      + [Uw campagnes beheren - VERBORGEN](campaign/using/marketing-campaign-monitoring.md)
      + [Providers, voorraden en budgetten - VERBORGEN](campaign/using/providers-stocks-and-budgets.md)
   + Campagneoptimalisatie {#campaign-optimization}
      + [Campagnetypologieën - VERBORGEN](campaign-opt/using/about-campaign-typologies.md)
      + [Regels voor druk - VERBORGEN](campaign-opt/using/pressure-rules.md)
      + [Regels voor consistentie - VERBORGEN](campaign-opt/using/consistency-rules.md)
      + [Regels voor beheer - VERBORGEN](campaign-opt/using/control-rules.md)
      + [Regels voor filters - VERBORGEN](campaign-opt/using/filtering-rules.md)
...
+ Marketing Resource Management {#mrm}
   + [Marketingbronnen beheren - VERBORGEN](mrm/using/about-marketing-resource-management.md)
   + [Taken maken en beheren - VERBORGEN](mrm/using/creating-and-managing-tasks.md)
   + [Beheerkosten - VERBORGEN](mrm/using/controlling-costs.md)
   + [Marketingbronnen beheren - VERBORGEN](mrm/using/managing-marketing-resources.md)
   + [Discussieforums - VERBORGEN](mrm/using/discussion-forums.md)
+ Gedistribueerde marketing {#distributed-marketing}
   + [Distributed marketing - VERBORGEN](distributed/using/about-distributed-marketing.md)
   + [Een lokale campagne maken - VERBORGEN](distributed/using/creating-a-local-campaign.md)
   + [Een collaboratieve campagne maken - VERBORGEN](distributed/using/creating-a-collaborative-campaign.md)
   + [Het campagnepakket publiceren - VERBORGEN](distributed/using/publishing-the-campaign-package.md)
   + [Toegang tot campagnes - VERBORGEN](distributed/using/accessing-campaigns.md)
   + [Een campagne bijhouden - VERBORGEN](distributed/using/tracking-a-campaign.md)
   + [Gebruiksscenario - VERBORGEN](distributed/using/examples.md)
...
+ Automatiseren met workflows {#automating-with-workflows}
   + Aan de slag met workflows {#introduction}
      ...
      + [Workflowgegevens gebruiken - VERBORGEN](workflow/using/how-to-use-workflow-data.md)
      + [Best practices voor workflows - VERBORGEN](workflow/using/workflow-best-practices.md)
   + Een workflow uitvoeren {#executing-a-workflow}
      ...
      + [Levenscyclus van gegevens - VERBORGEN](workflow/using/data-life-cycle.md)
   ...
   + Targetingactiviteiten {#targeting-activities}
      + [Targetingactiviteiten - VERBORGEN](workflow/using/about-targeting-activities.md)
      + [Query - VERBORGEN](workflow/using/query.md)
      + [Incrementele query - VERBORGEN](workflow/using/incremental-query.md)
      + [Leeslijst - VERBORGEN](workflow/using/read-list.md)
      + [Samenvoeging - VERBORGEN](workflow/using/union.md)
      ...
      + [Leveringsoverzicht - VERBORGEN](workflow/using/delivery-outline.md)
      ...
      + [Dimensiewijziging - VERBORGEN](workflow/using/change-dimension.md)
      ...
      + [Databron wijzigen - VERBORGEN](workflow/using/change-data-source.md)
   + Workflowbeheeractiviteiten {#flow-control-activities}
      + [Flowbeheeractiviteiten - VERBORGEN](workflow/using/about-flow-control-activities.md)
      + [Start en einde - VERBORGEN](workflow/using/start-and-end.md)
      + [Fork - VERBORGEN](workflow/using/fork.md)
      + [AND-join - VERBORGEN](workflow/using/and-join.md)
      + [Planner - VERBORGEN](workflow/using/scheduler.md)
      + [Testen - VERBORGEN](workflow/using/test.md)
      + [Wachten - VERBORGEN](workflow/using/wait.md)
      + [Tijdbeperking - VERBORGEN](workflow/using/time-constraint.md)
      + [Subworkflow - VERBORGEN](workflow/using/sub-workflow.md)
      + [Sprong (begin- en eindpunt) - VERBORGEN](workflow/using/jump-start-point-and-end-point.md)
      ...
      + [Taken - VERBORGEN](workflow/using/task.md)
   + Actieactiviteiten {#action-activities}
      + [Actieactiviteiten - VERBORGEN](workflow/using/about-action-activities.md)
      + [Levering - VERBORGEN](workflow/using/delivery.md)
      + [Leveringscontrole - VERBORGEN](workflow/using/delivery-control.md)
      ...
      + [Cross-channel leveringen - VERBORGEN](workflow/using/cross-channel-deliveries.md)
      ...
      + [Contentmanagement - VERBORGEN](workflow/using/content-management.md)
      + [Gegevensextractie (bestand) - VERBORGEN](workflow/using/extraction-file.md)
      + [SQL-code en JavaScript-code - VERBORGEN](workflow/using/sql-code-and-javascript-code.md)
      + [SQL Data Management - VERBORGEN](workflow/using/sql-data-management.md)
      + [Nlserver-module - VERBORGEN](workflow/using/nlserver-module.md)
      + [Samenvoeging bijwerken - VERBORGEN](workflow/using/update-aggregate.md)
   + Gebeurtenisactiviteiten {#event-activities}
      + [Gebeurtenisactiviteiten - VERBORGEN](workflow/using/about-event-activities.md)
      + [Bestandsophaler - VERBORGEN](workflow/using/file-collector.md)
   ...
   + Gebruiksscenario’s {#use-cases}
      + [Gebruiksscenario’s voor workflows - VERBORGEN](workflow/using/about-workflow-use-cases.md)
      + Leveringen {#deliveries}
         + [De lokale goedkeuringsactiviteit gebruiken - VERBORGEN](workflow/using/using-the-local-approval-activity.md)
         + [Een verjaardags-e-mail verzenden - VERBORGEN](workflow/using/sending-a-birthday-email.md)
         + [Leveringscontent laden - VERBORGEN](workflow/using/loading-delivery-content.md)
         + [Cross-channel leveringsworkflow - VERBORGEN](workflow/using/cross-channel-delivery-workflow.md)
   ...
   + Controle {#monitoring}
      ...
      + [Gepersonaliseerde waarschuwingen verzenden naar operatoren - VERBORGEN](workflow/using/sending-personalized-alerts-to-operators.md)
   + Data management {#data-management}
      + [Gegevensupdates coördineren - VERBORGEN](workflow/using/coordinating-data-updates.md)
      + [Een overzichtslijst maken - VERBORGEN](workflow/using/creating-a-summary-list.md)
      + [Gegevens verrijken- VERBORGEN](workflow/using/enriching-data.md)
      + [Samenvoegingen gebruiken - VERBORGEN](workflow/using/using-aggregates.md)
      + [De samenvoegfunctionaliteit van de deduplicatieactiviteit gebruiken - VERBORGEN](workflow/using/deduplication-merge.md)
   ...
   + Query&#39;s uitvoeren en filteren {#query-and-filter-hidden}
      ...
      + [Een query uitvoeren met behulp van groeperingsbeheer - VERBORGEN](workflow/using/querying-using-grouping-management.md)
      + [Een query uitvoeren met behulp van een veel-op-veel-relatie - VERBORGEN](workflow/using/querying-using-many-to-many-relationship.md)
      + [Een berekend veld van het opsommingstype toevoegen - VERBORGEN](workflow/using/adding-enumeration-type-calculated-field.md)
      + [Een filter maken - VERBORGEN](workflow/using/creating-a-filter.md)
      + [Gedupliceerde ontvangers filteren - VERBORGEN](workflow/using/filtering-duplicated-recipients.md)
   + Workflows bewaken {#monitoring-workflows}
      + [Workflowuitvoering controleren - VERBORGEN](workflow/using/monitoring-workflow-execution.md)
      + [Technische workflows controleren - VERBORGEN](workflow/using/monitoring-technical-workflows.md)
      + [Workflow HeatMap - VERBORGEN](workflow/using/heatmap.md)
   + Geavanceerd beheer {#advanced-management}
      ...
      + [Voorbeelden van JavaScript-code in workflows - VERBORGEN](workflow/using/javascript-in-workflows.md)
      + [Toegang tot een externe database - VERBORGEN](workflow/using/accessing-an-external-database-fda.md)
      + [Machtigingen beheren - VERBORGEN](workflow/using/managing-rights.md)
      + [Activiteitsafbeeldingen wijzigen - VERBORGEN](workflow/using/managing-activity-images.md)
