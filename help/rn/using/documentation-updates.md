...
De releasestatussen zijn teruggebracht en vereenvoudigd. [Meer informatie](rn-overview.md)

De pakketinstallatie van Linux is bijgewerkt voor v7.4.1. [Meer informatie](../../installation/using/installing-packages-with-linux.md)

### Juni 2024 {#june-2024}

Sectie 7.4.1. van de aanvullende informatie is bijgewerkt met verbeteringen, compatibiliteitsupdates en patches. [Meer informatie](latest-release.md)
...
Externe FDA-accountconfiguratie toegevoegd voor Amazon Redshift. [Meer informatie](../../installation/using/configure-fda-redshift.md)
...
De technische beschrijving van de workflow Facturering (billing) bevat nu de taken die oorspronkelijk werden uitgevoerd door Aantal actieve factureringsprofielen (billingActiveContactCount). [Meer informatie](../../workflow/using/about-technical-workflows.md)
...
* [Een leveringssjabloon configureren en implementeren](../../delivery/using/about-templates.md)
...
* [Seeds en proefversies in een e-mail beheren](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html?lang=nl#target-population){target="_blank"}.
