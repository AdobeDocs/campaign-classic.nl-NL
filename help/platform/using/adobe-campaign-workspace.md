...
>[!NOTE]
>
>Leren om tot filters toegang te hebben, te ontwerpen en te delen, naar de [&#x200B; Campagne v8 (console) documentatie &#x200B;](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/audience/create-filters){target=_blank} verwijzen.
