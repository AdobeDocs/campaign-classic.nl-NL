...
Leer meer over het gebruiken van de Webinterface in de [&#x200B; documentatie van de Campagne v8 &#x200B;](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-create.html?lang=nl-NL#use-the-web-interface-){target=_blank}.
