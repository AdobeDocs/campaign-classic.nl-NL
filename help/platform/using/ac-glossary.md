...
Meer informatie over [Clientconsole](../../platform/using/adobe-campaign-workspace.md).
+++
...
Meer informatie over [Goedkeuring van inhoud](../../campaign/using/marketing-campaign-approval.md).
+++
...
Meer informatie over [Kubussen](../../reporting/using/about-cubes.md).
+++
...
Meer informatie over [Leveringen](../../delivery/using/communication-channels.md).
+++
...
Meer informatie over [Leveringsanalyse](../../delivery/using/steps-validating-the-delivery.md#analyzing-the-delivery).
+++
...
Meer informatie over [Direct mail](../../delivery/using/about-direct-mail-channel.md).
+++
...
Meer informatie over [Implementatiewizard](../../installation/using/deploying-an-instance.md#deployment-wizard).
+++
...
Meer informatie over [Beschrijvende analyse](../../reporting/using/about-descriptive-analysis.md)
+++
...
Meer informatie over [Subsidiabiliteitsregels](../../interaction/using/interaction-and-offer-management.md).
+++
...
Meer informatie over [Weergave Verkenner](../../platform/using/adobe-campaign-explorer.md).
+++
...
Meer informatie over [Vermogensbeheer](../../campaign-opt/using/pressure-rules.md).
+++
...
Meer informatie over [Federale gegevenstoegang](../../installation/using/about-fda.md).
+++
...
Meer informatie over [Goedkeuring van bestandsuitwinning](../../delivery/using/validating.md).
+++
...
Meer informatie over [Dimensie filteren](../../workflow/using/building-a-workflow.md#targeting-and-filtering-dimensions).
+++
...
Meer informatie over [Mappen](../../platform/using/adobe-campaign-explorer.md).
+++
...
Meer informatie over [Heatmap](../../workflow/using/heatmap.md).
+++
...
Meer informatie over [Hybride implementatie](../../installation/using/hosting-models.md#hybrid).
...
Meer informatie over [Binnenkomende interactie](../../interaction/using/about-inbound-channels.md).
+++
...
Meer informatie over [Instantie-instellingen](../../installation/using/about-initial-configuration.md).
...
Meer informatie over [Lijsten](../../platform/using/creating-and-managing-lists.md).
+++
...
Meer informatie over [Benoemde rechten](../../platform/using/access-management-named-rights.md).
+++
...
Meer informatie over [Voorstellen aanbieden](../../interaction/using/creating-offer-spaces.md#offer-proposition-statuses).
+++
...
Meer informatie over [Aanbiedingssimulaties](../../interaction/using/about-offers-simulation.md).
+++
...
Meer informatie over [Thema&#39;s aanbieden](../../interaction/using/integrating-an-offer-via-the-wizard.md).
+++
...
Meer informatie over [Uitgaande interactie](../../interaction/using/about-outbound-channels.md).
+++

+++**Pakket exporteren/importeren**
...
Meer informatie over [Pakket exporteren/importeren](../../platform/using/working-with-data-packages.md).
+++
...
Meer informatie over [Palet](../../workflow/using/building-a-workflow.md#adding-and-linking-activities).
+++
...
Meer informatie over [Prestatiebewaking](../../production/using/monitoring-processes.md).
+++
...
Meer informatie over [Velden aanpassen](../../delivery/using/personalization-fields.md).
+++

+++**Variabelen voor aanpassen**

Personaliseringsvariabelen zijn stukken code in een levering die verschillende tekst aan verschillende ontvangers kunnen tonen die op de informatie van de ontvanger wordt gebaseerd. Deze gebieden kunnen als of een verpersoonlijkingsgebied of blok worden uitgevoerd.

Meer informatie over [Variabelen voor aanpassen](../../delivery/using/about-personalization.md).
+++
...
Meer informatie over [Abonnementen](../../campaign/using/setting-up-marketing-campaigns.md).
+++
...
Meer informatie over [Programma&#39;s](../../campaign/using/setting-up-marketing-campaigns.md).
+++
...
Meer informatie over [Push](../../delivery/using/about-mobile-app-channel.md).
+++
...
Meer informatie over [Services](../../delivery/using/about-services-and-subscriptions.md).
+++
