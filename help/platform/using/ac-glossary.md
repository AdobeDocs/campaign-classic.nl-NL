...
Leer meer over [ activiteiten van het Werkschema ](../../workflow/using/about-activities.md).
+++
...
Leer meer over de [ Lokale activiteit van de Goedkeuring ](../../workflow/using/local-approval.md).
+++
...
Leer meer over [ Soorten publiek ](../../campaign/using/marketing-campaign-target.md).
+++
...
Leer meer over [ Campagnes ](../../campaign/using/designing-marketing-campaigns.md).
+++
...
Leer meer over [ goedkeuring van de Inhoud ](../../campaign/using/marketing-campaign-approval.md).
+++
...
Leer meer over [ groepen van de Controle ](../../campaign/using/marketing-campaign-target.md#defining-a-control-group).
+++
...
Leer meer over [ analyse van de Levering ](../../delivery/using/steps-validating-the-delivery.md#analyzing-the-delivery).
+++
...
Leer meer over [ Distributie van waarden ](../../platform/using/defining-filter-conditions.md#selecting-data-to-extract)
+++
...
Leer meer over [ Subsidiabiliteitsregels ](../../interaction/using/interaction-and-offer-management.md).
+++
...
Leer meer over [ E-mail BCC ](../../delivery/using/email-parameters.md#email-bcc).
+++
...
Leer meer over [ de activiteit van de Verrijking ](../../workflow/using/enrichment.md).
+++
...
Leer meer over [ mening van de Ontdekkingsreiziger ](../../platform/using/adobe-campaign-explorer.md).
+++
...
Leer meer over [ het beheer van de Vermoeidheid ](../../campaign-opt/using/pressure-rules.md).
+++
...
Leer meer over [ goedkeuring van de extractie van het Dossier ](../../delivery/using/validating.md).
+++
...
Leer meer over [ het Filtreren afmeting ](../../workflow/using/building-a-workflow.md#targeting-and-filtering-dimensions).
+++
...
Leer meer over [ Omslagen ](../../platform/using/adobe-campaign-explorer.md).
+++
...
Leer meer over [ Mening van de Omslag ](../../platform/using/adobe-campaign-explorer.md).
+++
...
Leer meer over [ Heatmap ](../../workflow/using/heatmap.md).
+++
...
Leer meer over [ invoer en de uitvoerbanen ](../../platform/using/get-started-data-import-export.md).
+++
...
Leer meer over [ MRM ](../../mrm/using/about-marketing-resource-management.md).
+++
...
Leer meer over [ Boom van de Navigatie ](../../platform/using/adobe-campaign-explorer.md#about-navigation-hierarch).
+++
...
Leer meer over [ Doelstellingen ](../../mrm/using/creating-and-managing-tasks.md#expenses-and-revenues).
+++
...
+++**Levende milieu van de Aanbieding**
...
Leer meer over [ Palet ](../../workflow/using/building-a-workflow.md#adding-and-linking-activities).
+++
...
Leer meer over [ Abonnementen ](../../campaign/using/setting-up-marketing-campaigns.md).
+++
...
Leer meer over [ vooraf bepaalde filters ](../../platform/using/creating-filters.md#filtering-recipients).
+++
...
Leer meer over [ Programma&#39;s ](../../campaign/using/setting-up-marketing-campaigns.md).
+++
...
Leer meer over [ de dienstenactiviteit van de Abonnementsdiensten ](../../workflow/using/subscription-services.md).
+++
...
Leer meer over [ goedkeuring van het Doel ](../../workflow/using/local-approval.md).
+++
...
Leer meer over [ gegevens van het Doel ](../../workflow/using/data-life-cycle.md#target-data).
+++
...
Leer meer over [ het richten activiteiten ](../../workflow/using/about-targeting-activities.md).
+++
...
Leer meer over [ het richten dimensie ](../../workflow/using/targeting-data.md).
+++
...
Leer meer over [ activiteit van de Taak ](../../workflow/using/task.md).
+++
...
Leer meer over [ teweeggebrachte Gecentreerde Componenten ](../../workflow/using/external-signal.md).
+++
...
Leer meer over [ Typologies ](../../campaign-opt/using/about-campaign-typologies.md#typologies).
+++
...
Leer meer over [ de regels van de Typologie ](../../campaign-opt/using/about-campaign-typologies.md#typology-rules).
+++
...
Leer meer over [ Dagboek van het Werkschema ](../../workflow/using/monitoring-workflow-execution.md).
+++
