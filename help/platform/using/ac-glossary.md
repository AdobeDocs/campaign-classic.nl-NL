...
Een A/B-test is een mogelijkheid waarmee de gebruiker twee tot drie e-mailvarianten kan definiëren: elke variant wordt naar bevolkingsmonsters gestuurd om te bepalen welk resultaat het beste is. Zodra dit is bepaald, wordt de winnende variant naar de resterende populatie verzonden.
