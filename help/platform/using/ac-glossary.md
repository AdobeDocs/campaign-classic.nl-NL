...
Leer meer over [ het Volgen logboeken in Campagne v8 ](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/tracking-logs){target="_blank"} of [ v7-specifiek volgen ](../../delivery/using/about-message-tracking.md).
+++
