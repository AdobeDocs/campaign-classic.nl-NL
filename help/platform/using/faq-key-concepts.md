...
Als beheerder van de Campagne, kunt u opstellingstoestemmingen voor gebruikers van uw organisatie.

Dit zijn een reeks rechten en beperkingen die toestaan of weigeren om:

* Toegang tot bepaalde functies
* Toegang tot bepaalde gegevens
* Gegevens maken, wijzigen en/of verwijderen.

[Klik hier voor meer](../../platform/using/access-management.md) informatie over gebruikersmachtigingen.
...
[Klik hier voor meer](../../workflow/using/about-workflows.md) informatie over workflows. U kunt ook best practices voor [workflows](../../workflow/using/building-a-workflow.md)lezen.

## Hoe maak en verzend een eerste e-mail? {#how-to-create-and-send-a-first-email-}

[Klik hier voor meer](../../delivery/using/about-email-channel.md) informatie of [bekijk deze video](https://docs.adobe.com/content/help/en/campaign-learn/campaign-classic-tutorials/getting-started/creating-a-campaign-and-an-email.html) om een e-mail te maken in een campagne.

## Hoe je SMS-berichten verzendt? {#how-to-send-sms-messages-}

Leer hoe u uw platform configureert en SMS-berichten verzendt [in deze sectie](../../delivery/using/sms-channel.md).
...
Leer hoe u een online enquête [kunt](../../web/using/getting-started-with-surveys.md)maken met de belangrijkste stappen voor het ontwerpen en publiceren van deze enquête met Campaign Classic.
...
## Wat zijn best practices voor beveiliging (op locatie)? {#what-are-security-best-practices--on-premise--}

Lees uit de controlelijst [van de configuratie van de](https://helpx.adobe.com/campaign/kb/acc-security.html) Veiligheid om zeer belangrijke elementen te ontdekken om betreffende veiligheidsconfiguratie en het verharden voor plaatsingen op-gebouw te controleren.
...
Leer hoe u een webformulier [](../../web/using/about-web-forms.md)maakt: een webformulier ontwerpen, testen, publiceren en antwoorden verzamelen.
