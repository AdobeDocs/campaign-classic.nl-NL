...
Meer over de mogelijkheden van Adobe Campaign leren, en hoe te beginnen te worden, verwijs naar de [&#x200B; documentatie van de Campagne v8 &#x200B;](https://experienceleague.adobe.com/nl/docs/campaign/campaign-v8/new/get-started){target=_blank}.
...
* Leer hoe te met [&#x200B; Ontdekkingsreiziger van de Campagne &#x200B;](adobe-campaign-workspace.md#using-adobe-campaign-explorer) te werken.
