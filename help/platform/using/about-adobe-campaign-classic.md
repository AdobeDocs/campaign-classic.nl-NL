...
>[!NOTE]
>
>Adobe Campaign Classic is beschikbaar in v6.11 en v7. Behalve wanneer dit wordt vermeld, zijn de Help-materialen van toepassing op beide versies in de recentste build. Schermafbeeldingen geven de gebruikersinterface van Campaign Classic v7 weer.
