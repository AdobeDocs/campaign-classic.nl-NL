...
1. Klik op de knop **[!UICONTROL Add]** om functies aan te roepen. Voor meer op dit, verwijs naar [ Lijst van functies ](../../platform/using/adobe-campaign-workspace.md#about-queries-in-campaign).
