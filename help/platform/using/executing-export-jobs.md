...
* Klik op **[!UICONTROL Add a calculated field]** als u een nieuw berekend veld wilt maken (bijvoorbeeld een kolom met de achternaam + voornaam). Raadpleeg [Berekende velden](../../platform/using/executing-import-jobs.md#calculated-fields) voor meer informatie hierover.
