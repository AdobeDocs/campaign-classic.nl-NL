...
The workflows detailed in this section are installed with the different Adobe Campaign built-in packages. Deze pakketten en de bijbehorende technische workflows zijn afhankelijk van uw licentieovereenkomst. Ingebouwde pakketten worden beschreven in [deze sectie](../../installation/using/installing-campaign-standard-packages.md).
...
De technische werkschema&#39;s kunnen slechts door exploitanten met het recht van het Beleid worden begonnen en worden gewijzigd. Voor meer informatie over toestemmingen, verwijs naar dit [sectie](../../platform/using/access-management-groups.md#default-groups).
...
Raadpleeg de [specifieke sectie](monitoring-technical-workflows.md) voor meer informatie over het bewaken van technische workflows.

## Lijst met technische workflows {#list-technical-workflows}

| Technische workflow | Pakket | Beschrijving |
|------|--------|-----------|
| **Alias Cleansing**  (aliasCleansing) | Levering | This workflow standardizes enumeration values. Deze wordt standaard elke dag om 3 uur geactiveerd. |
...
| **Delete privacy requests data** (deletePrivacyRequestsData) | Verordening inzake bescherming van privacydata | Deze workflow verwijdert de gegevens die de ontvanger in Adobe Campaign heeft opgeslagen. |
...
| **Soorten publiek exporteren naar de Adobe Experience Cloud**  (exportSharedAudience) | Integratie met Adobe Experience Cloud | This workflow exports audiences as shared audiences/segments. Deze doelgroepen kunnen worden gebruikt in de verschillende Adobe Experience Cloud-oplossingen die u gebruikt. |
...
| **Import audiences from the Adobe Experience Cloud** (importSharedAudience) | Integratie met Adobe Experience Cloud | This workflow allows you to import audiences/segments from different Adobe Experience Cloud solutions into Adobe Campaign. |
...
| **Update**  van toegangstoken van LIJN V2 (updateLineV2AccessToken) | LINE-kanaal - alleen campagne v7 | Deze werkstroom verfrist het toegangstoken aan LIJN V2. |
...
| **Facebook-ventilatoren**  synchroniseren (FacebookFans synchroniseren) | Sociale netwerken (sociale marketing) - Alleen campagne v7 | This workflow imports Facebook fans into Adobe Campaign every day at 7am. |
| **Facebook-pagina** &#39;s synchroniseren (Facebook synchroniseren) | Sociale netwerken (sociale marketing) - Alleen campagne v7 | Deze workflow synchroniseert elke dag om 7.00 uur Facebook-pagina&#39;s met Adobe Campaign. |
| **Twitter-pagina** &#39;s synchroniseren (Twitter synchroniseren) | Sociale netwerken (sociale marketing) - Alleen campagne v7 | Deze workflow importeert elke dag om 7.00 uur Twitter-volgers naar Adobe Campaign. |
...
| **Update voor leverability** (DeliabilityUpdate) | Levering | Once the Deliverability monitoring (Email Deliverability) package is installed, this workflow runs nightly and manages the bounce emails qualification rules, as well as the list of domains and MXs. Hiervoor moet de HTTPS-poort open zijn op het platform. |