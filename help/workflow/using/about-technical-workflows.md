...
| **NMAC opt-out beheer** (mobileAppOptOutMgt) | Mobiel App-kanaal | Met deze workflow worden afmeldingsopties op mobiele apparaten bijgewerkt. Het wordt teweeggebracht om de 6 uur tussen 1am en middernacht. Voor meer details, verwijs naar [&#x200B; deze sectie &#x200B;](../../delivery/using/delivery-failures-quarantine.md#push-notification-quarantines). |
