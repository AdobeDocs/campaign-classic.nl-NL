...
In het volgende voorbeeld wordt een [incrementele query](incremental-query.md) gebruikt om een lijst met ontvangers automatisch bij te werken. Deze ontvangers zijn gericht op seizoensgebonden marketingcampagnes.
...
1. Configureer het tabblad **[!UICONTROL Incremental query]** van de activiteit zoals opgegeven in [Een query](query.md#creating-a-query) maken.
...
1. Na het goedkeuren van de stijgende vraag, vorm de activiteit van de lijstupdate zoals die in [Update ](list-update.md) wordt verklaard.
