...
Zie [Profielen synchroniseren](../../integrations/using/synchronizing-profiles.md) voor instructies voor het verzenden van levering in Campaign Standard met behulp van gerepliceerde profielen. Er zijn aanvullende instructies beschikbaar voor het delen van de gegevens voor niet-abonnementen tussen Campagne v7 en Campaign Standard.
...
Met de **basisimplementatie** kunt u ontvangers (velden buiten de verpakking), services en abonnementen, webtoepassingen en publiek repliceren. Dit is een eenrichtingsreplicatie van Campagne v7 naar Campaign Standard.
...
Alle technische elementen met betrekking tot de Schakelaar ACS zijn beschikbaar in **[!UICONTROL Administration > ACS Connector]** knoop van de ontdekkingsreiziger.
...
* **[!UICONTROL `[ACS] Profile replication`]** (newProfileReplication): in deze incrementele workflow worden ontvangers naar Campaign Standard gerepliceerd. Standaard worden alle ontvangende velden buiten het vak gerepliceerd. Zie [Standaardontvangervelden](#default-recipient-fields).
* **[!UICONTROL `[ACS] Service replication`]** (newServiceReplication): deze incrementele werkstroom repliceert de gekozen services naar Campaign Standard. Zie het gebruiksgeval [Webtoepassingen synchroniseren](../../integrations/using/synchronizing-web-applications.md).
* **[!UICONTROL `[ACS] Landing pages replication`]** (newLandingPageReplication): deze incrementele workflow repliceert de gekozen webtoepassingen naar Campaign Standard. De Campagne v7-webtoepassingen worden weergegeven als bestemmingspagina&#39;s in Campaign Standard. Zie het gebruiksgeval [Webtoepassingen synchroniseren](../../integrations/using/synchronizing-web-applications.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> Geen contact meer (door om het even welk kanaal)<br /> </td> 
   <td> @blackList<br /> </td> 
  </tr> 
  <tr> 
   <td> Geen contact meer via e-mail<br /> </td> 
  ...
  <tr> 
   <td> Adres 3 (Number and street)<br /> </td> 
...
1. Onder **[!UICONTROL Administration > ACS Connector > Rights management > Security groups]**, gebruik **[!UICONTROL Synchronize]** knoop om alle de veiligheidsgroepen van de Campaign Standard terug te winnen. Campaign Standard-groepen buiten de doos zijn uitgesloten.
...
1. Onder **[!UICONTROL Administration > ACS Connector > Data mapping]**, creeer een het richten afbeelding op de **[!UICONTROL nms:recipient]** lijst.
...
1. Open de toepassingsworkflow voor de toegewezen profielreplicatie (niet de sjabloon, maar de werkstroominstantie zelf). Wijzig **[!UICONTROL Query]** en **[!UICONTROL Update data]** activiteiten om deze gebieden te omvatten. Zie [Technische en replicatieworkflows](#technical-and-replication-workflows).
...
1. Onder **[!UICONTROL Administration > ACS Connector > Data mapping]**, creeer een het richten afbeelding op uw lijst van het douaneprofiel.
