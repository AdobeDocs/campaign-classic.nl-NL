...
Voor meer bij stuitkwalificatie, zie [ deze sectie ](delivery-failures-quarantine.md#bounce-mail-qualification).
...
Wanneer soft-bouncing berichten terug van Verbeterde MTA worden gemeld, tonen zij nog steeds als **[!UICONTROL Sent]** en het **[!UICONTROL Success]** percentage wordt nog niet bijgewerkt. De soft-bouncing berichten worden dan [ opnieuw geprobeerd ](delivery-failures-quarantine.md#retries-after-a-delivery-temporary-failure) door de periode van de leveringsgeldigheid:
