...
* De module Adobe Campaign Classic Digital Content Editor (DCE) bevat een aantal responsieve ontwerpsjablonen voor mobiele apparaten die beschikbaar zijn via **[!UICONTROL Resources]** > **[!UICONTROL Templates]** > **[!UICONTROL Content templates]** . Leer meer [ in dit artikel ](https://theblog.adobe.com/responsive-email-design-101/)
