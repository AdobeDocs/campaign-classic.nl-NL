...
Leer hoe te om leveringsmalplaatjes in [ Campagne v8 documentatie ](https://experienceleague.adobe.com/nl/docs/campaign/campaign-v8/send/create-templates){target="_blank"} tot stand te brengen en te gebruiken .