...
* Voer in het veld **[!UICONTROL Label]** de naam van de service in en selecteer het leveringskanaal: e-mail-, mobiele, Facebook-, Twitter- of mobiele toepassingen.
   ...
   >[!NOTE]
   >
   >Facebook- en Twitter-abonnementen worden beschreven in [deze sectie](../../social/using/about-social-marketing.md). Abonnementen voor mobiele toepassingen worden beschreven in [Mobiel toepassingskanaal](about-mobile-app-channel.md).
