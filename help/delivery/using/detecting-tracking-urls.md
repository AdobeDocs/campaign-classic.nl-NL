...
Bijvoorbeeld, is de `<a href="http://<%=myURL%>">` syntaxis **niet veilig** en moet worden vermeden.
...
* Tidy kan sommige koppelingen onjuist repareren, wat willekeurig kan gebeuren. Het typische symptoom is een stuk HTML dat in de e-mailproefdrukken maar niet in de voorproef zichtbaar is.
