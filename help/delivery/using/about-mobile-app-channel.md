...
Als u de iOS HTTP/2-connector via een proxy moet gebruiken, raadpleegt u deze [pagina](../../installation/using/file-res-management.md#proxy-connection-configuration).
